...
export default function DashboardPage() {
  ...
  // "Today" is anchored to the most recent date actually present in the sales
  // record — the seed history is a fixed window (June 2024 – June 2026), so
  // anchoring to the real wall clock could land a day past the last entry and
  // always show zero. Every figure below is a real sum, no baseline padding.
